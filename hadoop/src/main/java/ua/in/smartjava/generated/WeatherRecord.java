...
public class WeatherRecord extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 25913822912587841L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"WeatherRecord\",\"namespace\":\"ua.in.smartjava.generated\",\"doc\":\"A weather reading.\",\"fields\":[{\"name\":\"year\",\"type\":\"int\"},{\"name\":\"temperature\",\"type\":\"int\"},{\"name\":\"stationId\",\"type\":\"string\"}]}");
   ...
   */
  public static ua.in.smartjava.generated.WeatherRecord.Builder newBuilder() {
    return new ua.in.smartjava.generated.WeatherRecord.Builder();
  }
   ...
   * @return A new WeatherRecord RecordBuilder
   */
  public static ua.in.smartjava.generated.WeatherRecord.Builder newBuilder(ua.in.smartjava.generated.WeatherRecord.Builder other) {
    return new ua.in.smartjava.generated.WeatherRecord.Builder(other);
  }
   ...
   * @return A new WeatherRecord RecordBuilder
   */
  public static ua.in.smartjava.generated.WeatherRecord.Builder newBuilder(ua.in.smartjava.generated.WeatherRecord other) {
    return new ua.in.smartjava.generated.WeatherRecord.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<WeatherRecord>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(ua.in.smartjava.generated.WeatherRecord.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(ua.in.smartjava.generated.WeatherRecord other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.year)) {
        this.year = data().deepCopy(fields()[0].schema(), other.year);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public ua.in.smartjava.generated.WeatherRecord.Builder setYear(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ua.in.smartjava.generated.WeatherRecord.Builder clearYear() {
    ...
    /**
      ...
      * @return This builder.
      */
    public ua.in.smartjava.generated.WeatherRecord.Builder setTemperature(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ua.in.smartjava.generated.WeatherRecord.Builder clearTemperature() {
    ...
    /**
      ...
      * @return This builder.
      */
    public ua.in.smartjava.generated.WeatherRecord.Builder setStationId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ua.in.smartjava.generated.WeatherRecord.Builder clearStationId() {
      stationId = null;
